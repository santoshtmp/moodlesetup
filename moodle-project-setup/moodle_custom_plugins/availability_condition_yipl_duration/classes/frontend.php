...
class frontend extends \core_availability\frontend {
    ...
    protected function get_javascript_init_params($course, \cm_info $cm = null,
        ...
        if ($cachekey !== $this->cachekey) {
            ...
            if ($previouscm) {
                $previous = (object)['id' => \availability_yipl_duration\condition::OPTION_PREVIOUS,
                        'name' => get_string('option_previous', 'availability_yipl_duration'),
                        'completiongradeitemnumber' => \availability_yipl_duration\condition::OPTION_PREVIOUS];
