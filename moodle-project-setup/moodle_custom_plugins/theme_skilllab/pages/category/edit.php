...
// this file is the customize file of original course/editcategory.php
...
$url = new moodle_url('/theme/skilllab/pages/category/edit.php');
if ($id) {
...
$PAGE->set_pagetype('skilllab-category-edit');

// $PAGE->set_heading($fullname);

$mform = new \theme_skilllab\form\skl_edit_category(null, array(
    'categoryid' => $id,
...
// $manageurl = new moodle_url('/theme/skilllab/pages/category/index.php');
$manageurl = new moodle_url('/category');
