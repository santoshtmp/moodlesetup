...
class activity_navigation extends \core_course\output\activity_navigation
{
    ...
    public function __construct($prevmod, $nextmod, $activitylist = array())
    {
        ...
        if ($nextmod) {
            ...
            $css_clss = 'btn btn-link  ';
            if ($nextmod->uservisible) {
                $this->next_link_lock = false;
            } else {
                $this->next_link_lock = true;
                $css_clss .= ' locked ';
            }
            $attributes = [
                'class' => $css_clss,
    ...
    public function export_for_template(\renderer_base $output)
    {
        ...
        $data->next_link_lock = $this->next_link_lock;
