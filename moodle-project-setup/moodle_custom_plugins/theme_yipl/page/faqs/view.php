...
$url = new moodle_url('/theme/yipl/page/faqs/view.php');
$page_title = 'FAQs';
$PAGE->set_context($context);
$PAGE->set_url($url);
$PAGE->set_pagelayout('custompages'); // admin , standard , ...
$PAGE->set_pagetype('faqs-view');
...
if ($yipl_faqs == '1') {
    ...
    $template_content = [
        ...
        'faq_datas' => faqs_handler::get_faqs_question_data_in_array(-1),
    ];

    $template = 'theme_yipl/pages/faqs/faqs';
    $contents .= $OUTPUT->render_from_template($template, $template_content);
}
else {
    $contents = "FAQs is disable to view. ";
}
/**
 * ========================================================
 * -------------------  Output Content  -------------------
