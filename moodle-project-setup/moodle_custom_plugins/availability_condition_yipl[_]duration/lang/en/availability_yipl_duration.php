...
$string['description'] = 'Require students to complete (or not complete) certain time duration.';
...
$string['option_previous'] = 'Previous activity';
$string['pluginname'] = 'Restriction by YIPL time duration completion';
...
$string['title'] = 'Time duration completion';
$string['privacy:metadata'] = 'The Restriction by time duration completion plugin does not store any personal data.';
