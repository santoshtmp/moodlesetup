...
namespace theme_skilllab\output\core_user\myprofile;
...
class renderer extends \core_user\output\myprofile\renderer
{
    ...
    {
        $return = \html_writer::start_tag('div', array('class' => 'profile_tree skl_profile'));
    ...
    public function render_category(category $category)
    {
        ...
        foreach ($remove_section as $value) {
            if (in_array($category->title, $remove_section)) {
                return '';
            }
        }
