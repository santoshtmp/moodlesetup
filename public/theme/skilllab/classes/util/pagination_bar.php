...
class pagination_bar
{
     ...
     */
    protected function prepare(renderer_base $output, moodle_page $page, $target)
    {
     ...
     * @return stdClass
     */
    protected function export_for_template()
    {
        $data = new stdClass();
        $data->previous = null;
        $data->next = null;
    ...
    public function out($templatename = 'theme_skilllab/skilllab_pages/pagination_bar')
    {
        global $OUTPUT;
        $context = $this->export_for_template();
